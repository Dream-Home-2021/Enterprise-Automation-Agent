...
**Process:**
1. Save raw data or summaries to files in the working directory using `create_document` or `collect_data`.
2. Use tools (Google Search, Arxiv, Wikipedia, Scrape) to find info.

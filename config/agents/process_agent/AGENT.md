...
3. using the defined JSON structure
 <!-- Respond [Output Format Template] Based on your processing results, replace the variables in the following template and output： 
 {
    'messages': [],
    'structured_response': 
} -->
